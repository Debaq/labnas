...
fn api_routes() -> Router<AppState> {
    Router::new()
        ...
        .route("/api/auth/rename", post(handlers::auth::rename_user))
        .route("/api/auth/users", get(handlers::auth::list_users))
        .route("/api/auth/usernames", get(handlers::auth::list_usernames))
        ...
        .route("/api/system/services/{port}", put(handlers::system::update_service))
        // Network
        ...
        .route("/api/printers3d/queue/{id}", put(handlers::printers3d::update_queue_item))
        .route("/api/printers3d/queue/{id}", delete(handlers::printers3d::delete_queue_item))
        ...
        .route("/api/printing/printers/{name}/wake", post(handlers::printing::wake_printer_endpoint))
        ...
        .route("/api/events/{id}", put(handlers::tasks::update_event))
        ...
        .route("/api/events/categories/{id}", put(handlers::tasks::update_category))
        // Inventory
        .route("/api/inventory/categories", get(handlers::inventory::list_categories))
        .route("/api/inventory/categories", post(handlers::inventory::create_category))
        .route("/api/inventory/categories/{id}", put(handlers::inventory::update_category))
        .route("/api/inventory/categories/{id}", delete(handlers::inventory::delete_category))
        .route("/api/inventory/items", get(handlers::inventory::list_items))
        .route("/api/inventory/items", post(handlers::inventory::create_item))
        .route("/api/inventory/items/{id}", put(handlers::inventory::update_item))
        .route("/api/inventory/items/{id}", delete(handlers::inventory::delete_item))
